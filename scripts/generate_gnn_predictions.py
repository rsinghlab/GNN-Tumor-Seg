...
#Make sure model hyperparameters correspond to the weight file.
def load_model_and_weights(model_type,weight_file):
...
if __name__ == '__main__':
    ...
    net = load_net_and_weights(args.model_type,args.weight_file)
