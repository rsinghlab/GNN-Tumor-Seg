...
mod1,mod2,preds,gt = get_data_for_plotting(args.data_dir,args.seg_dir,args.mri_id,flair_ext,t1ce_ext,read_labels=args.plot_gt)

hs = 80 #horizontal slice
cs = 140 #coronal slice
ss = 120 #saggittal slice
